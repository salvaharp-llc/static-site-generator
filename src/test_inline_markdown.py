...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_split_bold_multiword(self):
        node = TextNode("**This is** the bolded phrase", TextType.TEXT)
        new_nodes = split_nodes_delimiter([node], "**", TextType.BOLD)
        self.assertListEqual(
            [
                TextNode("This is", TextType.BOLD),
                TextNode(" the bolded phrase", TextType.TEXT),
            ],
            new_nodes,
        )
    ...
    def test_extract_markdown_links(self):
        matches = extract_markdown_links(
            "This is a [link](https://www.google.com) and this is [another link](https://www.youtube.com)"
        )
        self.assertListEqual(
            [
